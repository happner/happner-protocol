...
{
  "data": {
    "id": "d6b036a2-d076-4dba-96ff-64c00fcd5799",
    "protocol": "happn_1.3.0",
    "happn": {
      "name": "TestNode",
      "secure": false,
...
```json
{
  ...
  "data": {
    ...
    "_meta": {
      ...
      "modified": 1497363718480,
      "path": "/test/write",
      "published": true,
      "type": "response",
      "status": "ok",
      "eventId": 4,
      "sessionId": "d6b036a2-d076-4dba-96ff-64c00fcd5799",
      "action": "set"
    }
  },
  "sessionId": "d6b036a2-d076-4dba-96ff-64c00fcd5799",
...
{
  "data": {
    "id": "9526ebde-6839-4872-9cab-48e51dd8f487",
    "protocol": "happn_1.3.0",
    "happn": {
      "name": "TestNode",
      "secure": false,
...
```json
{
  ...
  "path": "/mesh/schema/description",
  "data": null,
  "sessionId": "9526ebde-6839-4872-9cab-48e51dd8f487",
  "options": {
    "timeout": 60000,
    "options": {}
  }
...
```json
{
  "action": "on",
  "eventId": 6,
  "path": "/SET@/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/*",
  "data": null,
  "sessionId": "9526ebde-6839-4872-9cab-48e51dd8f487",
  "options": {
    "event_type": "set",
  ...
  "pathData": {
    "parts": [
      "/SET",
      "/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/*"
    ],
    "action": "SET"
  },
  "key": "/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/*"
}
```
</p>
...
```json
{
  ...
  "data": {
    "callbackAddress": "/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/TestNode/componentName/causeEventMethod/1",
    "args": [],
    "origin": {
      "id": "9526ebde-6839-4872-9cab-48e51dd8f487"
    }
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "9526ebde-6839-4872-9cab-48e51dd8f487",
    "consistency": 2,
    "publicationId": "9526ebde-6839-4872-9cab-48e51dd8f487-7"
  },
  "protocol": "happn_1.3.0"
}
```
...
```json
{
  "action": "set",
  "eventId": 15,
  "path": "/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/TestNode/componentName/causeEventMethod/1",
  "data": {
    "status": "ok",
    "args": [
      null,
...
```json
{
  ...
  "_meta": {
    ...
    "sessionId": "d6b036a2-d076-4dba-96ff-64c00fcd5799",
    "consistency": 2,
    "publicationId": "d6b036a2-d076-4dba-96ff-64c00fcd5799-14",
    "componentVersion": "1.0.0"
  },
  "__outbound": true,
  "protocol": "happn_1.3.0"
...
```json
{
  ...
  "_meta": {
    "path": "/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/TestNode/componentName/causeEventMethod/1",
    "channel": "/SET@/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/*",
    "action": "/SET@/_exchange/responses/9526ebde-6839-4872-9cab-48e51dd8f487/TestNode/componentName/causeEventMethod/1",
    "type": "data",
    "sessionId": "d6b036a2-d076-4dba-96ff-64c00fcd5799",
    "consistency": 2,
    "publicationId": "d6b036a2-d076-4dba-96ff-64c00fcd5799-15"
  },
  "__outbound": true,
  "protocol": "happn_1.3.0"
}
